...
# The percentage of males that were vaccinated equates to 87.29965 % 

percent_FEMALE_vaxxed <- female_vaccinated_count/sum(female_vaccinated_count,female_unvaccinated_count)
# The percentage of females that were vaccinated equates to 86.78854 %
...
male_min_age <- min(filtmensample_data_vaxx$AGE) #Here the minimum age is 18.
male_max_age <- max(filtmensample_data_vaxx$AGE) #Here the maximum age is 88.
...
# Calculate the minimum and maximum ages
fem_min_age <- min(filtFEMALEsample_data_vaxx$AGE) #Here the minimum age is 18.
fem_max_age <- max(filtFEMALEsample_data_vaxx$AGE) #Here the maximum age is 88.
...
# The level of an individuals income combined with education level.  
